                    ...
                    {userHobbies.length > 0 ? (
                        userHobbies.map((myhob, index) => (
                            <div key={index} className="relative w-full flex items-center group">
                                ...
                                <div className="absolute right-0 top-1/2 transform -translate-y-1/2 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 ease-in-out dark:bg-gray-700 bg-white p-6 rounded">
                                    <button
